...
// Muss zu den Default-Werten in src/index.css (:root, --bd-green-600 /
// --bd-gold-500) passen. Entspricht den Vereinsfarben des Streethockeyclub
// Bulldozers; kann pro Team in der teams-Tabelle (farbe_primaer/-sekundaer)
// überschrieben werden.
const STANDARD_PRIMAER = '#008066';
const STANDARD_SEKUNDAER = '#cfa225';
