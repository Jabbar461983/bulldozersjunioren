...
--
-- Übernimmt ausserdem unverändert die Freundeschallenge-Anbindung aus den
-- Migrationen 0011/0012 (kategorie-Lookup, aktualisiere_freundeschallenge_
-- bei_einschaetzung() vor der Badge-Prüfung) – ohne diese Migration hier
-- würde die letzte create-or-replace-Definition der Funktion gewinnen und
-- eines der beiden Features (individuelle Punkte oder Freundeschallenge)
-- stillschweigend wieder verschwinden.
-- ---------------------------------------------------------------------------
